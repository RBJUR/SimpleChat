...
public class ChooseUsernameFragment extends Fragment implements View.OnClickListener, UsernameFragmentView {
    ...
    public void onSuccess() {
        ...
        manager.beginTransaction().setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN).replace(R.id.register_activity_frame_layout, ChooseEmailFragment.newInstance(data), "email").commit();
    }
